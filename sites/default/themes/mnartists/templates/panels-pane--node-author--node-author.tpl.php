<?php
    ...
    $author_image_uri = (isset($article_author->picture->uri)) ? image_style_url('square_thumbnail', $article_author->picture->uri) : 'http://mnartist.imalab.us/sites/default/files/styles/square_thumbnail/public/pictures/picture-default.png';
?>
