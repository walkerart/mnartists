<?php
    // template for rendering a user's profile
?>
    ...
    <div class='user-profile-data'>
        <div class='left'>
            <?php if(!is_null($user->picture)) { ?>
                <div class='profile-image-wrapper'><img src='<?= image_style_url('artist-profile-photo',$user->picture->uri) ?>'></div>
            <?php } ?>
        </div>
        <div class='right'>
...
<div id='tabs'>
    ...
    <?php }
        if(isset($fieldset['field_education'])) { ?>
            <div class='wrap education'><h5 class='profile-title'>Education</h5>
            <?php foreach($fieldset['field_education'] as $edu) {
    ...
    <?php if(isset($fieldset['field_awards'])) { ?>
        <div id='tabs-<?= $ia ?>'>
            <?php foreach($fieldset['field_awards'] as $award1) {
                ...
                <?= $award['field_award_name'][0]['#markup'] ?>
