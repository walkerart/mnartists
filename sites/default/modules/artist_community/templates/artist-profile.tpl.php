...
<div class="artist-profile">
    ...
    <a href="<?php print $url; ?>" class="artist-profile-img">
        ...
        ?>
        <img src="<?php print  $image_uri ?>" width="100" height="100">
    </a>

    <?php if(user_is_logged_in()) : ?>
        <div class="pane-mnartist-collections-mna-collections-star">
            <ul class="menu follow-menu<?php if ($is_flagged) print 'collected'; ?>">
                <li class="first">
                    <a class='star-link'><img src='/<?php print  drupal_get_path('theme', 'mnartists') ?>/images/fav-star.svg' class='star-icon' alt="flag this" /></a>
                    <ul>
                        <li class='follow-this'><?php print  flag_create_link('usercollections', $user->uid) ?></li>
                        <hr>
                        <li class='share-this collect-title'>SHARE VIA:</li>
                        <li class='share-this'><a href='#' onclick='window.open("https://www.facebook.com/sharer/sharer.php?u=" + encodeURIComponent("<?php print  $base_url.$url ?>"), "facebook-share-dialog", "width=626,height=436"); return false;'>FACEBOOK</a></li>
                        <li class='share-this'><a href='#' onclick='window.open("https://twitter.com/share?url=" + encodeURIComponent("<?php print  $base_url.$url ?>"), "twitter-share-dialog", "width=626,height=436"); return false;'>TWITTER</a></li>
                    </ul>
                </li>
            </ul>
        </div>
